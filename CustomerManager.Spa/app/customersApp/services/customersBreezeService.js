(function () {
    ...
    var injectParams = ['breeze', '$q', '$window', 'config'];

    var customersBreezeService = function (breeze, $q, $window, config) {
        ...
        var serviceName = config.apiBaseUrl + '/breeze/breezedataservice';
